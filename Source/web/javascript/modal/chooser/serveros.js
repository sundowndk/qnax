serverOS : function (attributes)
{
	...
	{		
		...
		edit : function (attributes)
		{
			...
			{				
				...
				attributes.current = qnaxLib.management.serverOS.new ();
			}
			else
			{				
				...
				attributes.buttonLabel2 = "Close";
				attributes.current = qnaxLib.management.serverOS.load (chooser.getUIElement ("os").getItem ().id);
			}
			...
			var onButton1 = function ()
							{
								qnaxLib.management.serverOS.save (get ());
			...
			var action =	function (result)
							{
								if (result == 1)
								{
									...
									if (qnaxLib.management.serverOS.delete (id))
									{
	...
	var onButton1 =	function ()
					{
						...
						{
							var location = qnaxLib.management.serverOS.load (chooser.getUIElement ("os").getItem ().id);
	...
	chooser.getUIElement ("os").setItems (qnaxLib.management.serverOS.list ());
